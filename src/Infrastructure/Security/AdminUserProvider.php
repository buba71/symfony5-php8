...
final class AdminUserProvider implements UserProviderInterface, PasswordUpgraderInterface
{
    public function __construct(private UserDoctrineRepository $repository)
    {
    }
    ...
    {
        return $this->repository->getUserByEmail($username);
    }
